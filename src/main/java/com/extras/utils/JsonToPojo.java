...
public class JsonToPojo {
	...
	/**
	 * @param args This is a one time run utility ..comment after the use as it has main method() 
	 */
	public static void main(String[] args) {
		
		String packageName="com.json2pojo";
		File inputJson= new File("input.json");
		File outputPojoDirectory=new File("convertedPojo");
